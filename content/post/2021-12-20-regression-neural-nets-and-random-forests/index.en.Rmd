...
final_results <- bind_rows(
  generate('simple logistic', myrec, a_log, cells, cells),
  generate('random forest', myrec, a_for, cells, cells),
  generate('neural net', myrec, a_nn, cells, cells)
)
```
